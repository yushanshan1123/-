...
DEFAULT_REQUEST_ID = 'provider-failure-demo-001'
DEFAULT_TRACE_ID = 'trace-provider-failure-demo-001'
DEFAULT_USER_ID = 'telegram:provider-failure-demo-user'
DEFAULT_PROVIDER_MESSAGE_ID = 'provider-failure-message-001'


def run_provider_delivery_failure_demo(request_id: str = DEFAULT_REQUEST_ID):
    initial = build_delivery_result(
        ...
        payload={
            ...
            'message': 'provider failure demo message',
    ...
    after = transition_delivery_status(before, 'failed')
...
def main():
    ...
    result = run_provider_delivery_failure_demo(request_id)
